            ...
            <div className={formStyles.formTextLeft}>
              ...
              <div className={formStyles.text}>
                <p>Если вы знаете отличный сайт, который соответствует тематике 
                  ...
                  <p>Если вы <strong>владелец сайта</strong>, то укажите эту информацию в 
                  соответствующем чекбоксе. За небольшую плату можете добавить сайт со 100% 
                  вероятность или разместь рекламный блок.</p>
              </div>
            </div>
